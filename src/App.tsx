...
const PROJECTS = [
  ...
  },
  {
    ...
    link: "https://github.com/ShrivatsaDeshpande/Password-Manager" // Guessed link based on CV
  },
  {
    title: "Podcast Plus App",
    desc: "Advanced recommendation algorithms and 24/7 universal streaming, boosting engagement by 40%.",
    link: "https://github.com/ShrivatsaDeshpande/Podcast-Plus" // Guessed link
  },
  {
    ...
    link: "https://github.com/ShrivatsaDeshpande/student-ai-tools"
  },
  {
    title: "SSA-LAB",
        ...
        <section id="certificates" className="max-w-7xl mx-auto px-6 py-32 bg-gray-900/20 text-center">
          ...
          >
            {CERTIFICATES.map((cert, i) => (
              <SpotlightCard key={i} className="p-8 rounded-2xl border border-gray-800 bg-[#111] transition-colors flex flex-col items-center justify-center min-h-[220px]">
                <div className="w-16 h-16 bg-black border border-gray-800 rounded-full mb-6 flex items-center justify-center text-2xl font-black text-green-500 group-hover:bg-green-500/10 transition-colors shadow-lg">
                  {cert.year.slice(-2)}
                </div>
